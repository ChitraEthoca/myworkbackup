...
public class AddDeleteStaff  extends BaseTestClass {
...
//	Add Staff user id
			.addstaff(testData)	
//	Review & Confirm Staff Page
			.reviewAddstaff(testData).confirmAddstaff(testData)
//  Validate Delete Staff
			.deletestaff(testData)
//   Logout & Validate Successful Message 			
			.Logout(testData).UILogoutPage(testData);
		}	
		catch(Exception e){
