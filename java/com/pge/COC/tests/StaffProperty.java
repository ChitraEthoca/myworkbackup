...
// Ensure PMF assigned Property to Staff Member
public class StaffProperty  extends BaseTestClass {
...
// Navigate to URL
			String browsertype = testData.get("Browser");
			driver.navigate().to(COCDriverScript.globalParamMap.get("url"));
			COCDriverScript.logMessage("testStepPass", "Laungched Browser" +"" + "Browser Type =" +browsertype);
...
//	SignIn to PMP Page
			sp.Login(testData)
//   Validate Staff Property details page			
			 .ValdProprtyStaff(testData)
			 .StaffPropertyDetails(testData);
		}	
		catch(Exception e){
