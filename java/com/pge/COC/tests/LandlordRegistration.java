...
public class LandlordRegistration  extends BaseTestClass {
...
//	Launch the SignIn Page & Maximize
			...
			COCDriverScript.logMessage("testStepDone", "Home page launched");
//	Validate UI Functionality on SingIn Page
			sp.SPUIValidation(testData)
//	Navigate to LL Registration Page
			.navLLRegister(testData)
//	Register as LandLord
			.LLRegister(testData);
//	Click on Logout link  from Manage Properties Page
//			.Logout(testData)	
//	Validate Logout Page
//				.UILogoutPage(testData);
		}	
		catch(Exception e){
